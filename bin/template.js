...
Template.prototype.constructCssInclusions = function (options) {
   ...
   if (options.bootstrap) {
      css.push("<link rel='stylesheet' type='text/css' href='./node_modules/bootstrap/dist/css/bootstrap.min.css'>");
      css.push("<link rel='stylesheet' type='text/css' href='./node_modules/bootstrap/dist/css/bootstrap-theme.min.css'>");
   } else if (options.materialize) {
      css.push("<link rel='stylesheet' type='text/css' href='./node_modules/materialize-css/dist/css/materialize.min.css'>");
   }

   let c = options.components;
   for (let i = 0; i < c.length; i++) {
      css.push("<link rel='stylesheet' type='text/css' href='./components/" + c[i] + "/" + c[i] + ".css'>");
   }
